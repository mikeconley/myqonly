      ...
      switch (state.type) {
        case "bugzilla": {
          ...
          document.body.setAttribute(
            "total-bugzilla-reviews",
            state.data.reviewTotal || 0
          );
          document.body.setAttribute(
            "total-bugzilla-needinfos",
        ...
        case "phabricator": {
          ...
          document.body.setAttribute(
            "total-phabricator-user-reviews",
            serviceUserTotal || 0
          );
          ...
          document.body.setAttribute(
            "total-phabricator-group-reviews",
            serviceGroupTotal || 0
          );
        ...
        case "github": {
          ...
          document.body.setAttribute("total-github-reviews", serviceTotal || 0);
